...
public class ScheduleEditActivity extends AppCompatActivity {
    ...
    private String id,name,time,duration,stream;
    private EditText editTextName,editTextTime,editTextDuration;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(ScheduleEditActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        editTextDuration = (EditText)findViewById(R.id.et_duration);
        editTextDuration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(ScheduleEditActivity.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                    public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                        editTextDuration.setText( String.format("%02d",selectedHour) + ":" + String.format("%02d",selectedMinute));
                    }
                }, hour, minute, true);//Yes 24 hour time
    ...
    public void saveSettings(View view){
        ...
        String url = "http://lipa.kvewijk.nl/android/schedule/edit?session="
